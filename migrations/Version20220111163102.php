 ...
 */
final class Version20220111163102 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contenido (id INT AUTO_INCREMENT NOT NULL, seccion_contenidos_id INT NOT NULL, nombre VARCHAR(255) NOT NULL, descripcion LONGTEXT NOT NULL, url_archivo VARCHAR(255) DEFAULT NULL, INDEX IDX_D0A7397F192D137A (seccion_contenidos_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
