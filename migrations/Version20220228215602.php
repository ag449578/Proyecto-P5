 ...
 */
final class Version20220228215602 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE asignatura (id INT AUTO_INCREMENT NOT NULL, anno_imparte_id INT NOT NULL, nombre VARCHAR(255) NOT NULL, descripcion LONGTEXT NOT NULL, url_imagen VARCHAR(255) DEFAULT NULL, semestre INT NOT NULL, horas_clase INT NOT NULL, cantidad_temas INT NOT NULL, es_curricular TINYINT(1) NOT NULL, departamento VARCHAR(255) NOT NULL, INDEX IDX_9243D6CEF0CA256E (anno_imparte_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE contenido (id INT AUTO_INCREMENT NOT NULL, seccion_contenidos_id INT NOT NULL, nombre VARCHAR(255) NOT NULL, descripcion LONGTEXT NOT NULL, url_archivo VARCHAR(255) NOT NULL, INDEX IDX_D0A7397F192D137A (seccion_contenidos_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE profesor (id INT NOT NULL, asignatura_id INT DEFAULT NULL, categoria_docente VARCHAR(255) NOT NULL, INDEX IDX_5B7406D9C5C70C5B (asignatura_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE seccion_contenidos (id INT AUTO_INCREMENT NOT NULL, asignatura_id INT NOT NULL, nombre VARCHAR(255) NOT NULL, descripcion LONGTEXT NOT NULL, INDEX IDX_99B7AE15C5C70C5B (asignatura_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE asignatura_estudiante DROP FOREIGN KEY FK_731EBBE3C5C70C5B');
        ...
        $this->addSql('ALTER TABLE asignatura_estudiante DROP FOREIGN KEY FK_731EBBE359590C39');
